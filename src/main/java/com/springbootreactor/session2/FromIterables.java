...
import com.springbootreactor.SpringBootReactorApplication;
...
public class FromIterables implements CommandLineRunner{

    private static final Logger log = LoggerFactory.getLogger(SpringBootReactorApplication.class);

    public static void main(String[] args) {
        SpringApplication.run(FromIterables.class, args);
    }
